...
namespace FuncionariosAPI.Service.FuncionarioService
{
    ...
    {
        //injeção de dependência, aqui eu acesso todos os bancos criados dentro do 
        ...
        public async Task<ServiceResponse<FuncionarioModel>> GetFuncionarioById(int id)
        {
            ...
            try
            {
                FuncionarioModel funcionario = _context.Funcionarios.FirstOrDefault( funcionarioBanco => funcionarioBanco.Id == id );
        ...
        public async Task<ServiceResponse<List<FuncionarioModel>>> InativaFuncionario(int id)
        {
            ...
            try
            {
                FuncionarioModel funcionario = _context.Funcionarios.First(x => x.Id == id);
